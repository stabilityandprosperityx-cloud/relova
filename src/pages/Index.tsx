  ...
  return (
    <div className="min-h-screen bg-background bg-noise bg-grid">
      <SEO
        ...
        description="Expert relocation planning: visas, documents, and housing tailored to your passport and goals — a clear, step-by-step plan for your international move."
