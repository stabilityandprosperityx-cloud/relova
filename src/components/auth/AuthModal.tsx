        ...
        <div className="p-8 text-center">
          ...
          {mode === "choice" && (
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full h-11 text-[13px] gap-2.5 justify-center"
          ...
          {(mode === "email-signup" || mode === "email-login") && (
            <div className="space-y-3">
              ...
              <Button
                ...
                onClick={mode === "email-signup" ? handleEmailSignUp : handleEmailLogin}
              ...
              <p className="text-[11px] text-muted-foreground/60 pt-1">
                {mode === "email-signup" ? (
                  <>
                    Already have an account?{" "}
                    <button className="text-primary hover:underline" onClick={() => setMode("email-login")}>
                      Log in
                    </button>
                  </>
                ) : (
                  <>
                    ...
                    <button className="text-primary hover:underline" onClick={() => setMode("email-signup")}>
                      Sign up
                    </button>
                  </>
                )}
